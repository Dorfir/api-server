...
/* Re-init Image Creeper */
function resetImageCreeper() {
  filesearch_button.value = null
  dragDropArea.style.display = "block"
  saveCreeperStatus()
}

/* Save Creeper Status */
function saveCreeperStatus() {
  console.table(cropLines)
  console.table(imageCoord)
}
...
downloadBtn.addEventListener('click', function () {
  ...
  document.getElementById('display-result').addEventListener('click', (e) => {
    let display_result = document.getElementById('display-result')
    display_result.style.display = "block"
